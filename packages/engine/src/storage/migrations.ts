...
const migrations: Migration[] = [
  ...
  },
  {
    ...
    up: (db) => {
      ...
      if (!tableExists(db, "doc_chunks_fts")) {
        db.exec(`
      ...
      db.exec("CREATE INDEX IF NOT EXISTS idx_docs_project_id ON docs(project_id)");
      db.exec(
